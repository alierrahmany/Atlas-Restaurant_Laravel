...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h3 class="card-title mb-0">
            <i class="fas fa-user-cog me-1"></i>Informations du compte
        </h3>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('admin.accounts.store') }}" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <select class="form-select @error('type_compte') is-invalid @enderror" 
                                id="type_compte" name="type_compte" required>
                            
                            <option value="admin" {{ old('type_compte') == 'admin' ? 'selected' : '' }}>
                                Administrateur
                            </option>
                        </select>
